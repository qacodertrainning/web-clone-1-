 ...
 * @return void
 */
function appsero_init_tracker_duplicate_pp() {

    if ( ! class_exists( 'Appsero\Client' ) ) {
      require_once __DIR__ . '/appsero/src/Client.php';
    }

    $client = new Appsero\Client( '37a0e0a5-8537-4682-8020-084710ed3419', 'Duplicate Post, Page and Any Custom Post', __FILE__ );

    // Active insights
    $client->insights()->init();

}
appsero_init_tracker_duplicate_pp();
